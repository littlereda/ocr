...
import com.example.demo.utils.CoreFunc;
import com.example.demo.utils.IdCardCvUtils;
import com.example.demo.utils.OCRUtil;
import com.example.demo.utils.OpencvUtil;
...
import static com.example.demo.utils.OpencvUtil.shear;

@Service
public class OrcTestService {

    public static void main(String[] args) throws  Exception{
//        String path= ResourceUtils.getFile("classpath:test/5.jpg").getAbsolutePath();
        Mat mat= opencv_imgcodecs.imread("C:\\Users\\csht\\Desktop\\images\\13.jpg");
//        idcard(mat);
        cardUp(mat);
        // card(mat);
    }
    ...
    public static void idcard(Mat mat) throws  Exception{
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/houghLinesP.jpg", mat);
    ...
    public static String toCard(Mat mat,Rect rect){
       ...
       Mat hierarchy = new Mat();
		...
		for (Rect rectSor : sortedRect) {
			...
			// specMat);
			opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/debug_specMat" + x + ".jpg", specMat);
			x++;
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/card.jpg", card);
    ...
    public static void cardDown(Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/result.jpg", mat);
    ...
    public static String temp (Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/temp.jpg", temp);
    ...
    public static String organization (Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/organization.jpg", name);
    ...
    public static String time (Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/time.jpg", time);
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/start.jpg", start);
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/end.jpg", end);
...
//        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/face.jpg", face);
//        //灰度
        mat=OpencvUtil.flow(mat);
//        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/1.jpg", mat);
        //膨胀
        //mat=OpencvUtil.dilate(mat,1);
    ...
    public static String name(Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/name.jpg", name);
        BufferedImage nameBuffer=OpencvUtil.Mat2BufImg(name,".jpg");
        String nameStr=OCRUtil.getImageMessage(nameBuffer,"chi_sim",true);
        nameStr=nameStr.replace("\n","");
        return nameStr+"\n";
    ...
    public static String sex(Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/sex.jpg", sex);
    ...
    public static String nation(Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/nation.jpg", nation);
    ...
    public static String birthday(Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/birthday.jpg", birthday);
        //年份
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/year.jpg", year);
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/month.jpg", month);
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/day.jpg", day);
    ...
    public static String address(Mat mat){
        ...
        opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard2/address.jpg", address);
