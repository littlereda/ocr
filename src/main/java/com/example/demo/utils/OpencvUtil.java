...
public class OpencvUtil {
	...
	public static Mat carry(Mat mat) {
		...
		// 边缘检测
		//opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard/1.jpg", dst);
		opencv_imgproc.Canny(mat, dst, 50, 150);
		//opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard/2.jpg", dst);
		return dst;
	}
...
参数5：定义轮廓的近似方法，取值如下：
	...
	public static Mat houghLinesP(Mat begin, Mat mat) {
		...
		//opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard/22.jpg", newMat);
		Mat storage = new Mat();
		...
		//opencv_imgcodecs.imwrite("C:/Users/csht/Desktop/images/idcard/houghLinesP1.jpg", mat);
		return mat;
	}
